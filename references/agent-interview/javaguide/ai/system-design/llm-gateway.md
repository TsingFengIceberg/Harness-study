...
> **来源**: [https://javaguide.cn/ai/system-design/llm-gateway.html](https://javaguide.cn/ai/system-design/llm-gateway.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：AI 应用系统设计](ai-application-architecture.md) / [下一篇：AI 语音技术详解](ai-voice.md)
