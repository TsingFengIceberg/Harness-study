...
> **来源**: [https://javaguide.cn/ai/rag/rag-optimization.html](https://javaguide.cn/ai/rag/rag-optimization.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：GraphRAG 详解](graphrag.md)
