...
> **来源**: [https://javaguide.cn/ai/rag/graphrag.html](https://javaguide.cn/ai/rag/graphrag.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：RAG 知识库文档更新策略](rag-knowledge-update.md) / [下一篇：RAG 检索优化](rag-optimization.md)
