...
> **来源**: [https://javaguide.cn/ai/rag/rag-document-processing.html](https://javaguide.cn/ai/rag/rag-document-processing.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：⭐️RAG 基础概念详解](rag-basis.md) / [下一篇：⭐️RAG 向量索引算法和向量数据库](rag-vector-store.md)
