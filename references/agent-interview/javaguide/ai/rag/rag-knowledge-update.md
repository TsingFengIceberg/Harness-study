...
> **来源**: [https://javaguide.cn/ai/rag/rag-knowledge-update.html](https://javaguide.cn/ai/rag/rag-knowledge-update.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：⭐️RAG 向量索引算法和向量数据库](rag-vector-store.md) / [下一篇：GraphRAG 详解](graphrag.md)
