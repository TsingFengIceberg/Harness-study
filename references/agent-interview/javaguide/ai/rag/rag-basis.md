...
> **来源**: [https://javaguide.cn/ai/rag/rag-basis.html](https://javaguide.cn/ai/rag/rag-basis.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [下一篇：RAG 文档处理与切分策略](rag-document-processing.md)
