...
> **来源**: [https://javaguide.cn/ai/llm-basis/llm-api-engineering.html](https://javaguide.cn/ai/llm-basis/llm-api-engineering.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：万字拆解 LLM 运行机制](llm-operation-mechanism.md) / [下一篇：大模型结构化输出详解](structured-output-function-calling.md)
