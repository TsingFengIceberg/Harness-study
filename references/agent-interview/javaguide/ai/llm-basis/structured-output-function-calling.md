...
> **来源**: [https://javaguide.cn/ai/llm-basis/structured-output-function-calling.html](https://javaguide.cn/ai/llm-basis/structured-output-function-calling.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：大模型 API 调用工程实践](llm-api-engineering.md) / [下一篇：AI 应用评测体系](llm-evaluation.md)
