...
> **来源**: [https://javaguide.cn/ai/agent/skills.html](https://javaguide.cn/ai/agent/skills.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：上下文工程实战指南](context-engineering.md) / [下一篇：万字拆解 MCP 协议](mcp.md)
...
同一个概念，在一个 Skill 里尽量只用一个名字，例如你前面用到了 API 端点，后面就不要再写成 URL、API 路由或路径了。 这个问题看起来很小，但真会影响 Agent 执行。
