...
> **来源**: [https://javaguide.cn/ai/agent/context-engineering.html](https://javaguide.cn/ai/agent/context-engineering.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：提示词工程实战指南](prompt-engineering.md) / [下一篇：万字详解 Agent Skills](skills.md)
...
![Sub-agent 拆分任务，隔离上下文](https://oss.javaguide.cn/github/javaguide/ai/context-engineering/sub-agent-task-splitting-context-isolation.png)
