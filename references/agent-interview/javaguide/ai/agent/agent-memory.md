...
> **来源**: [https://javaguide.cn/ai/agent/agent-memory.html](https://javaguide.cn/ai/agent/agent-memory.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：⭐️AI Agent 核心概念详解](agent-basis.md) / [下一篇：提示词工程实战指南](prompt-engineering.md)
