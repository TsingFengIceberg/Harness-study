...
> **来源**: [https://javaguide.cn/ai/agent/prompt-engineering.html](https://javaguide.cn/ai/agent/prompt-engineering.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：⭐️AI Agent 记忆系统详解](agent-memory.md) / [下一篇：上下文工程实战指南](context-engineering.md)
...
关于 Context Engineering 的详细介绍，推荐阅读这篇：[上下文工程(Context Engineering) 是什么？和 Prompt Engineering 有什么区别？](https://javaguide.cn/ai/agent/context-engineering.html)
