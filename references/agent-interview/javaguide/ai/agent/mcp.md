...
> **来源**: [https://javaguide.cn/ai/agent/mcp.html](https://javaguide.cn/ai/agent/mcp.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：万字详解 Agent Skills](skills.md) / [下一篇：Harness Engineering 详解](harness-engineering.md)
...
它可能会规划步骤、调用工具、读取结果、继续判断，也可能会维护记忆、做循环、等待人工确认。![FC/MCP/Agent 三层关系图](https://oss.javaguide.cn/github/javaguide/ai/skills/mcp-fc-agent-layer.png)
