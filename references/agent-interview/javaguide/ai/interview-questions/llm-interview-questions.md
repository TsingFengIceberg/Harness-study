...
> **来源**: [https://javaguide.cn/ai/interview-questions/llm-interview-questions.html](https://javaguide.cn/ai/interview-questions/llm-interview-questions.html)  
> **抓取日期**: 2026-07-30  
> **资料性质**: JavaGuide 第三方网页机械提取  
> **证据状态**: to-verify

[返回 JavaGuide 本地索引](../../README.md) / [上一篇：⭐️AI 应用开发面试指南](ai-interview-guide.md) / [下一篇：AI Agent 面试题总结](agent-interview-questions.md)
