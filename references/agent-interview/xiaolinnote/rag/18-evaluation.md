...
[返回本地索引](README.md) / [上一章：17. 如何规避 RAG 系统中大模型的幻觉？](17-hallucination.md) / [下一章：19. RAG 知识库如何实现动态与持续更新？](19-dynamic-update.md)
...
![](https://cdn.xiaolincoding.com//picgo/1776839663387-754e535c-886a-4ee3-aa00-21a8e64ff6d5.png)**Context Recall（上下文召回率）**：要回答这个问题，所需要的信息有多少比例在检索结果里覆盖到了？这个指标需要有「标准答案」作为参照，衡量的是检索层有没有「漏掉该找到的内容」。目标值是 > 0.7。
