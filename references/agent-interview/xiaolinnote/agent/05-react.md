...
[返回本地索引](README.md) / [上一章：4. 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？](04-patterns.md) / [下一章：6. ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？](06-three-patterns.md)
