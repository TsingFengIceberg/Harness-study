...
[返回本地索引](README.md) / [上一章：10. SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒绝采样什么关系？](10-post-training.md) / [下一章：12. 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？](12-decoding-strategies.md)
