...
[返回本地索引](README.md) / [上一章：12. 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？](12-decoding-strategies.md) / [下一章：14. KV Cache 是什么？Prompt Caching 的原理是什么？](14-kv-cache-prompt-caching.md)
