...
[返回本地索引](README.md) / [上一章：2. 讲讲 Transformer 架构基本原理？Encoder 和 Decoder 是什么？](02-transformer-architecture.md) / [下一章：4. 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？](04-position-encoding.md)
