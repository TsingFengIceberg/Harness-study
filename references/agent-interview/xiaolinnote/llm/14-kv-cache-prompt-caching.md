...
[返回本地索引](README.md) / [上一章：13. 大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是什么？](13-temperature-top-p-top-k.md) / [下一章：15. 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？](15-quantization.md)
