...
[返回本地索引](README.md) / [上一章：1. 什么是大语言模型？和传统 NLP 模型有什么区别？](01-what-is-llm.md) / [下一章：3. 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？](03-mha-mqa-gqa-flash-attention.md)
